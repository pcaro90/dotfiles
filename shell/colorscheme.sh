...
color00="3b/3b/3b" # Base 00 - Black
color01="cf/6a/4c" # Base 08 - Red
color02="79/9d/6a" # Base 0B - Green
color03="d8/ad/4c" # Base 0A - Yellow
color04="59/7b/c5" # Base 0D - Blue
color05="a0/37/b0" # Base 0E - Magenta
color06="71/b9/f8" # Base 0C - Cyan
color07="ad/ad/ad" # Base 05 - White
color08="50/50/50" # Base 03 - Bright Black
color09=$color01 # Base 08 - Bright Red
color10=$color02 # Base 0B - Bright Green
color11=$color03 # Base 0A - Bright Yellow
